...
const getRiskColor = (riskLevel) => {
  switch (riskLevel.toLowerCase()) {
    ...
    case "high":
      return "bg-dark-danger/10 text-dark-danger";
    case "critical":
...
export default function RiskLevel() {
  ...
  return (
    <div className="min-h-screen bg-dark-background pt-24 px-4 pb-12">
              ...
              <table className="min-w-full divide-y divide-white/10">
                <thead className="bg-white/5">
                  <tr>
                    ...
                    <th className="hidden md:table-cell px-6 py-4 text-left text-sm font-semibold text-dark-text">
                      Velocity (km/h)
                    </th>
                    <th className="hidden lg:table-cell px-6 py-4 text-left text-sm font-semibold text-dark-text">
                      Miss Distance (km)
                    </th>
                    <th className="px-6 py-4 text-left text-sm font-semibold text-dark-text">
                      Risk Level
